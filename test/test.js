...
import walk_39 from './walk_39-hospitals-make-him-really-nervous.json' with { type: 'json' }
import walk_40 from './walk_40-sit-back-and-enjoy-the-show.json' with { type: 'json' }
import walk_41 from './walk_41-roasted-dicks-of-course.json' with { type: 'json' }
import walk_42 from './walk_42-as-you-wee-around-the-room.json' with { type: 'json' }
import walk_43 from './walk_43-a-budding-friendship.json' with { type: 'json' }

const latest = walk_43
...
describe('Calorie ensemble tests', async () => {
  ...
  it('calorieEnsemble test - walk_37', async () => {
    console_log('')
    console_log('calorie ensemble function test using walk_37 data file')
    const coords = walk_37.features[0].geometry.coordinates
    const date_37 = new Date(walk_37.features[0].properties.date)
      .toLocaleDateString('en-US', {
        month: '2-digit',
        day: '2-digit',
        year: 'numeric',
      })
    const weight = walk_37.features[0].properties.weights
    const bodyW = _dot1(weight.body / 2.2)
    const ruckW = _dot1(weight.ruck / 2.2)
    const bmr = {
      height: HEIGHT, weight: bodyW, age: AGE, sex: SEX,
    ...
    results.push({
      date: date_37,
      name: clipName(walk_37.features[0].properties.name),
      distance: dist(walk_37.features[0].properties.distance),
      duration: _dot1(m2m(walk_37.features[0].properties.duration)),
      avgSpd: _dot1(resultSet.pandolf.avgSpeedMs),
      weights: walk_37.features[0].weights = `b: ${_dot1(weight.body / 2.2)}, `
        + `r: ${_dot1(weight.ruck / 2.2)}`,
      apple: walk_37.features[0].properties.apple.activity,
  ...
  it('calorieEnsemble test - walk_39', async () => {
    console_log('')
    console_log('calorie ensemble function test using walk_39 data file')
    const coords = walk_39.features[0].geometry.coordinates
    const date_39 = new Date(walk_37.features[0].properties.date)
      .toLocaleDateString('en-US', {
        month: '2-digit',
        day: '2-digit',
        year: 'numeric',
      })
    const weight = walk_39.features[0].properties.weights
    const bodyW = _dot1(weight.body / 2.2)
    const ruckW = _dot1(weight.ruck / 2.2)
    const bmr = {
      height: HEIGHT, weight: bodyW, age: AGE, sex: SEX,
    ...
    results.push({
      date: date_39,
      name: clipName(walk_39.features[0].properties.name),
      distance: dist(walk_39.features[0].properties.distance),
      duration: _dot1(m2m(walk_39.features[0].properties.duration)),
      avgSpd: _dot1(resultSet.pandolf.avgSpeedMs),
      weights: walk_39.features[0].weights = `b: ${_dot1(weight.body / 2.2)}, `
        + `r: ${_dot1(weight.ruck / 2.2)}`,
      apple: walk_39.features[0].properties.apple.activity,
      simple1: _dot1(walk_39.features[0].properties.simpleCalories),
      simple2: _dot1(walk39Simple),
      pandolf1: _dot1(walk_39.features[0].properties.pandolfCalories.totalKcal),
      pandolf2: _dot1(resultSet.pandolf.totalKcal),
      lcda: _dot1(resultSet.lcda.totalKcal),
      minMech: _dot1(resultSet.minMech.totalKcal),
    })
  ...
  it('calorieEnsemble test - walk_40', async () => {
    console_log('')
    console_log('calorie ensemble function test using walk_40 data file')
    const coords = walk_40.features[0].geometry.coordinates
    const date_40 = new Date(walk_37.features[0].properties.date)
      .toLocaleDateString('en-US', {
        month: '2-digit',
        day: '2-digit',
        year: 'numeric',
      })
    const weight = walk_40.features[0].properties.weights
    const bodyW = _dot1(weight.body / 2.2)
    const ruckW = _dot1(weight.ruck / 2.2)
    const bmr = {
      height: HEIGHT, weight: bodyW, age: AGE, sex: SEX,
    ...
    results.push({
      date: date_40,
      name: clipName(walk_40.features[0].properties.name),
      distance: dist(walk_40.features[0].properties.distance),
      duration: _dot1(m2m(walk_40.features[0].properties.duration)),
      avgSpd: _dot1(resultSet.pandolf.avgSpeedMs),
      weights: walk_40.features[0].weights = `b: ${_dot1(weight.body / 2.2)}, `
        + `r: ${_dot1(weight.ruck / 2.2)}`,
      apple: walk_40.features[0].properties.apple.activity,
      simple1: _dot1(walk_40.features[0].properties.simpleCalories),
      simple2: _dot1(walk40Simple),
      pandolf1: _dot1(walk_40.features[0].properties.pandolfCalories.totalKcal),
      pandolf2: _dot1(resultSet.pandolf.totalKcal),
      lcda: _dot1(resultSet.lcda.totalKcal),
      minMech: _dot1(resultSet.minMech.totalKcal),
    })
  ...
  it('calorieEnsemble test - walk_41', async () => {
    console_log('')
    console_log('calorie ensemble function test using walk_41 data file')
    const coords = walk_41.features[0].geometry.coordinates
    const date_41 = new Date(walk_37.features[0].properties.date)
      .toLocaleDateString('en-US', {
        month: '2-digit',
        day: '2-digit',
        year: 'numeric',
      })
    const weight = walk_41.features[0].properties.weights
    const bodyW = _dot1(weight.body / 2.2)
    const ruckW = _dot1(weight.ruck / 2.2)
    const bmr = {
      height: HEIGHT, weight: bodyW, age: AGE, sex: SEX,
    ...
    const walk41Simple = simpleCalories(
      m2m(walk_41.features[0].properties.duration),
      {
        body: _dot1(weight.body / 2.2),
        ruck: _dot1(weight.ruck / 2.2),
        water: 0,
    ...
    results.push({
      date: date_41,
      name: clipName(walk_41.features[0].properties.name),
      distance: dist(walk_41.features[0].properties.distance),
      duration: _dot1(m2m(walk_41.features[0].properties.duration)),
      avgSpd: _dot1(resultSet.pandolf.avgSpeedMs),
      weights: walk_41.features[0].weights = `b: ${_dot1(weight.body / 2.2)}, `
        + `r: ${_dot1(weight.ruck / 2.2)}`,
      apple: walk_41.features[0].properties.apple.activity,
      simple1: _dot1(walk_41.features[0].properties.simpleCalories),
      simple2: _dot1(walk41Simple),
      pandolf1: _dot1(walk_41.features[0].properties.pandolfCalories.totalKcal),
      pandolf2: _dot1(resultSet.pandolf.totalKcal),
      lcda: _dot1(resultSet.lcda.totalKcal),
      minMech: _dot1(resultSet.minMech.totalKcal),
    })
  ...
  it('calorieEnsemble test - walk_42', async () => {
    console_log('')
    console_log('calorie ensemble function test using walk_42 data file')
    const coords = walk_42.features[0].geometry.coordinates
    const date_42 = new Date(walk_37.features[0].properties.date)
      .toLocaleDateString('en-US', {
        month: '2-digit',
        day: '2-digit',
        year: 'numeric',
      })
    const weight = walk_42.features[0].properties.weights
    const bodyW = _dot1(weight.body / 2.2)
    const ruckW = _dot1(weight.ruck / 2.2)
    const bmr = {
      height: HEIGHT, weight: bodyW, age: AGE, sex: SEX,
    ...
    const walk42Simple = simpleCalories(
      m2m(walk_42.features[0].properties.duration),
      {
        body: _dot1(weight.body / 2.2),
        ruck: _dot1(weight.ruck / 2.2),
        water: 0,
    ...
    results.push({
      date: date_42,
      name: clipName(walk_42.features[0].properties.name),
      distance: dist(walk_42.features[0].properties.distance),
      duration: _dot1(m2m(walk_42.features[0].properties.duration)),
      avgSpd: _dot1(resultSet.pandolf.avgSpeedMs),
      weights: walk_42.features[0].weights = `b: ${_dot1(weight.body / 2.2)}, `
        + `r: ${_dot1(weight.ruck / 2.2)}`,
      apple: walk_42.features[0].properties.apple.activity,
      simple1: _dot1(walk_42.features[0].properties.simpleCalories),
      simple2: _dot1(walk42Simple),
      pandolf1: _dot1(walk_42.features[0].properties.pandolfCalories.totalKcal),
      pandolf2: _dot1(resultSet.pandolf.totalKcal),
      lcda: _dot1(resultSet.lcda.totalKcal),
      minMech: _dot1(resultSet.minMech.totalKcal),
    })
  ...
  it('calorieEnsemble test - walk_43', async () => {
    console_log('')
    console_log('calorie ensemble function test using walk_43 data file')
    const coords = walk_43.features[0].geometry.coordinates
    const date_43 = new Date(walk_37.features[0].properties.date)
      .toLocaleDateString('en-US', {
        month: '2-digit',
        day: '2-digit',
        year: 'numeric',
      })
    const weight = walk_43.features[0].properties.weights
    const bodyW = _dot1(weight.body / 2.2)
    const ruckW = _dot1(weight.ruck / 2.2)
    const bmr = {
      height: HEIGHT, weight: bodyW, age: AGE, sex: SEX,
    ...
    const walk43Simple = simpleCalories(
      m2m(walk_43.features[0].properties.duration),
      {
        body: _dot1(weight.body / 2.2),
        ruck: _dot1(weight.ruck / 2.2),
        water: 0,
    ...
    results.push({
      date: date_43,
      name: clipName(walk_43.features[0].properties.name),
      distance: dist(walk_43.features[0].properties.distance),
      duration: _dot1(m2m(walk_43.features[0].properties.duration)),
      avgSpd: _dot1(resultSet.pandolf.avgSpeedMs),
      weights: walk_43.features[0].weights = `b: ${_dot1(weight.body / 2.2)}, `
        + `r: ${_dot1(weight.ruck / 2.2)}`,
      apple: walk_43.features[0].properties.apple.activity,
      simple1: _dot1(walk_43.features[0].properties.simpleCalories),
      simple2: _dot1(walk43Simple),
      pandolf1: _dot1(walk_43.features[0].properties.pandolfCalories.totalKcal),
      pandolf2: _dot1(resultSet.pandolf.totalKcal),
      lcda: _dot1(resultSet.lcda.totalKcal),
      minMech: _dot1(resultSet.minMech.totalKcal),
    })
